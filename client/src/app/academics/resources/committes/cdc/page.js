...
const cdcMembers = [
    ...
    { sr: 4, name: "SMT. P D ZAGADE", designation: "LOCAL MEMBERS", email: "shindepinky23@gmail.com" },
    { sr: 5, name: "DR. ANJULA S. CHOWBE", designation: "PRINCIPAL", email: "anjulachowbe@gmail.com" },
    { sr: 6, name: "MR. KHAN SHOYEB SARFARAZ", designation: "SECRETARY OF COLLEGE STUDENTS' COUNCIL", email: "shoyebkhan202@gmail.com" },
    { sr: 7, name: "MRS. ANURADHA RAJENDRA NAGAWADE", designation: "SECRETARY OF THE MANAGEMENT", email: "anuradhanagawade@gmail.com" },
    { sr: 8, name: "SHRI. FATE PURUSHOTTAM JAGANNATH", designation: "TEACHERS", email: "pjfate96@gmail.com" },
    { sr: 9, name: "MS. SAKSHI BABU PRATHAMSHETTY", designation: "WOMEN TEACHERS", email: "prathamshettysakshi111@gmail.com" },
    ...
    return (
        <div className="committee-detail-page">
            <div className="committee-header">
                <h1>College Development Committee (CDC)</h1>
            </div>
