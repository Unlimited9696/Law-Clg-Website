...
const womenCellMembers = [
    ...
    { sr: 4, name: "SHRI. FATE PURUSHOTTAM JAGANNATH", designation: "MEMBER 1", email: "pjfate96@gmai.lcom" },
    ...
    return (
        <div className="committee-detail-page">
            <div className="committee-header">
                <h1>Women's Anti-Sexual Harassment Cell</h1>
            </div>
                ...
                <section className="members">
                    ...
                    <div className="desktop-view">
                        <table className="members-table">
                            ...
                            <tbody>
                                {womenCellMembers.map((member, index) => (
                                    <tr key={index}>
